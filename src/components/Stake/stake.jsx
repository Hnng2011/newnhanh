...
const stake = () => {
    return (
        <div className='Stake'>
            ...
            <h1>Stake to Earn</h1>
            <div className='stakefieldbg'>
                <div className='stakefield'>
                    <h2>BaseX Staking Statistics</h2>
                    <div className='stakefield1'>
                        <div className='curstake'>
                    ...
                    <div className='stakefield2'>
                        <div className='staking'>
                            <h3>My Staking</h3>
                            <div>
                                <img src='https://pbs.twimg.com/profile_images/1688065316914692096/WeBSpzpK_400x400.png' />
                                <div>0 BASEX</div>
